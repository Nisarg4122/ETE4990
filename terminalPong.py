...
def main():
    ...
    ball_process = = multiprocessing.ball_process(target=move_ball) #Multi process solution here
    ball_process.start()
    
    input_thread = threading.Thread(target = handle_input) #threaded solution here
    input_thread.start()
